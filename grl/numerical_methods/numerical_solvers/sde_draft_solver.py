...
class TorchSDE(nn.Module):
    ...
    def h(self, t, y):
        """
        Overview:
            The draft function of the DraftSDE.
        """
        return self.draft(t, y)


class SDEDraftSolver:
    ...
    def integrate(self, drift, draft, diffusion, x0, t_span, logqp=False, adaptive=False):
        """
        Overview:
            Integrate the SDE.
        Arguments:
