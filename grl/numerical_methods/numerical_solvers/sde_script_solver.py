...
class TorchSDE(nn.Module):
    ...
    def script(self, t, s):
        """
        Overview:
            The script function of the ScriptSDE.
        """
        return self.script(t, s)


class SDEScriptSolver:
    ...
    def integrate(self, drift, diffusion, x0, script_x, t_span, logqp=False, adaptive=False):
        """
        Overview:
            Integrate the SDE.
        Arguments:
        ...
        trajectory = torchsde.sdeint_script(
            sde,
            x0,
            script_x,
            t_span,
