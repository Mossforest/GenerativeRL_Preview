...
if __name__ == "__main__":
    ...
    for iteration in track(range(config.parameter.iterations), description="Training"):
        ...
        # if True:
            ...
            x0_eval, x1_eval, action_eval = customized_eval_dataset.data['state'], customized_eval_dataset.data['next_state'], customized_eval_dataset.data['action']
        ...
        if config.parameter.training_loss_type == "flow_matching":
            loss = flow_model.flow_matching_loss(x0=batch_data['next_state'], x1=batch_data['state'], condition=batch_data['action'])
        else:
